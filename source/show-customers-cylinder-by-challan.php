...
$user = new user();
$gettran=$user->getCustomersCylinderByChallanDeli($challan_id);
...
<link href="assets/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet" />
    ...
    <td><?=$row['cy_no'];?></td>
    <td>Returned</td>
    <td>Delivered Through - <?=$row['chln_no'];?></td>
    <td>
        <!--<div class="d-flex align-items-center gap-3 fs-6">-->
        <!--<a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Delete" aria-label="Delete" onclick="deleteReturnC('<?=$row['id'];?>','<?=$challan_id;?>','<?=$row['cy_id'];?>');"><i class="bi bi-trash-fill"></i></a>-->
        <!--</div>-->
    </td>
    </tr>
    <?php $count++; } ?>

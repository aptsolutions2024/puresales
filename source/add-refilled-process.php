...
{  
$res=$user->insertMastDelRefillChln($login_id,$cust_id,$challan_no,$chln_date,$vehicle_no,$cy_action,$gas_id,$cylinderR,$cylinderRetR,$currentDateTime);
$_SESSION['adddelmsg']='001';
}

}else if($action=='editAction')
{
$res=$user->updateDelRefillChln($cust_id,$challan_id,$chln_date,$vehicle_no,$cy_action,$gas_id,$cylinderR,$cylinderRetR);
}
